...
class MessageHandler {
  ...
  // Check if sender is authorized - FIXED FOR GROUPS
  isAuthorized(sender, jid) {
    // DEBUG: Log all incoming messages
    console.log('🔍 AUTHORIZATION CHECK:');
    console.log('🔍 Raw sender JID:', sender);
    console.log('🔍 Chat JID:', jid);
    console.log('🔍 Is group:', jid.endsWith('@g.us'));
    
    // Extract phone number from JID - FIXED FOR GROUP FORMAT
    ...
    console.log('🔍 Authorized numbers:', settings.authorizedNumbers);
